...
import templateUrl from '@vezubr/common/assets/templates/Импорт Адресов (шаблон).csv';
import ImportError from '../import-error';

const ImportAddresses = (props) => {
  ...
  const handleChange = useCallback(
    (info, status) => {
      if (status === 'error') {
        ...
        showAlert({
          content: 'Адреса были успешно импортированы',
          onOk,
        });
      }
    },
  ...
  return (
    <div className={'import-addresses'}>
