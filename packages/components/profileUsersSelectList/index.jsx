...
const ProfileUsersSelectList = (props) => {
  const { onSave, onCancel, defaultParams = {}, submitButtonText, selectType = 'radio' } = props;
  ...
  return (
    ...
    <div>
      ...
      <div className='user-contractors__actions'>
        ...
        <Ant.Button onClick={handleSubmit} loading={loading} disabled={selectedRowKeys.length < 1}>
