...
class Contracts extends ApiBaseClass {
  ...
  async editAgreement(id, data) {
    return await this.req('post', CP.contracts.agreement(id), data);
  }

  async deleteAgreement({id}) {
    return await this.req('delete', CP.contracts.agreement(id));
  }
  ...
  async tariffsForAssign(id, data) {
    return await this.req('post', CP.contracts.tariffsForAssign(id), data);
  }
