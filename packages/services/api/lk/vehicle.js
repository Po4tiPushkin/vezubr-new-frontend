...
class Vehicle extends ApiBaseClass {
  ...
  async listCompatibleForOrderTractor(id, data) {
    return await this.req('post', CP.vehicle.listCompatibleForOrderTractor(id), data)
  }

  async systemTypes(data) {
    return await this.req('post', CP.vehicle.systemTypes, data);
  }

  async contourTypes(data) {
    return await this.req('post', CP.vehicle.contourTypes, data);
  }

  async counterpartyTypes(id, data) {
    return await this.req('get', CP.vehicle.counterpartyTypes(id));
  }

  async setContourTypes(data) {
    return await this.req('post', CP.vehicle.setContourTypes, data);
  }

  async calendar(data) {
    return await this.req('post', CP.vehicle.calendar, data);
  }
