...
class Registries extends ApiBaseClass {
  ...
  async create(data) {
    return await this.req('post', CP.registries.createRegistries, data);
  }

  async getOrdersList(data) {
    return await this.req('post', CP.registries.getOrdersList, data);
  }

  async addOrders(data) {
    return await this.req('post', CP.registries.addOrders(data.id),({orders:data.orders}))
  }

  async removeOrders(data) {
    return await this.req('post', CP.registries.removeOrders(data.id),({orders:data.orders}))
  }
