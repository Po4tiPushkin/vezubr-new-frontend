...
function RegularOrderCreate(props) {
  ...
  const chooseOrderType = React.useCallback((type) => {
    setOrderType(type)
    setShowModal(false)
  }, [setShowModal, setOrderType])
  ...
  return (
    <>
      ...
      <Modal
        ...
        maskClosable
      >
        <div className="flexbox column align-center justify-center regular-order__type">
          <Ant.Button
            type="regular"
            block
            onClick={() => {
...
RegularOrderCreate.propTypes = {
  match: PropTypes.object,
  location: PropTypes.object,
};

RegularOrderCreate.contextTypes = {
