...
import usePreparatosInfo from "./hooks/usePreparatorsInfo";
...
const Preparators = (props) => {
  ...
  const infos = usePreparatosInfo({ order, dictionaries, reportFiles });
