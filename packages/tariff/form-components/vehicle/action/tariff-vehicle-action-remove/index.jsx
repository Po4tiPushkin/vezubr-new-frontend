...
function TariffVehicleActionRemove(props) {
  ...
  if (!vehicle.vehicleTypeId && !vehicle.speciality) {
    return null;
  }
  ...
  return (
    <Ant.Popover
      ...
      trigger="click"
      title={vehicle.speciality ? "Удалить специалиста?" : "Удалить машину?"}
      content={
    ...
    >
      <Ant.Icon
        ...
        type="delete"
        style={{ color: 'red' }}
        title={vehicle.type ? "Удалить специалиста" : "Удалить машину"}
        />
    </Ant.Popover>
  );
}
