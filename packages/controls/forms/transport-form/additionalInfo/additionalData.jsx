...
const ADDITIONAL_FIELDS = {
  ...
  hasGPSMonitoring: 'hasGPSMonitoring'
}
  ...
  return (
    <VzForm.Group title={'Дополнительные параметры'}>
      <VzForm.Row>
        ...
        <VzForm.Col span={6}>
          <VzForm.Item disabled={disabled} error={getFieldError(ADDITIONAL_FIELDS.hasGPSMonitoring)}>
            {getFieldDecorator(ADDITIONAL_FIELDS.hasGPSMonitoring, {
              initialValue: values?.[ADDITIONAL_FIELDS.hasGPSMonitoring] || false,
              rules: rules[ADDITIONAL_FIELDS.hasGPSMonitoring](getFieldsValue()),
            })(
              <VzForm.FieldSwitch
                disabled={disabled}
                checkedTitle={'Наличие GPS датчика'}
                unCheckedTitle={'Наличие GPS датчика'}
                colorChecked={false}
                checked={getFieldValue(ADDITIONAL_FIELDS.hasGPSMonitoring) || false}
              />,
            )}
          </VzForm.Item>
        </VzForm.Col>
