...
function SettingsOrderCityForm(props) {
  ...
  return (
    <div className={'settings-order-city-form'}>
...
SettingsOrderCityForm.propTypes = {
...
export default compose([withOrderStore(OrderDataTransport)])(SettingsOrderCityForm);
