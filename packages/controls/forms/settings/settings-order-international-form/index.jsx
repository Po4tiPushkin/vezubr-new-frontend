...
function SettingsOrderInternationalForm(props) {
  ...
  const orderDocumentCategoriesTreeData = useMemo(() => {
    const { international } = getOrderDocumentsRequired(orderDocumentCategories);
...
SettingsOrderInternationalForm.propTypes = {
...
export default compose([withOrderStore(OrderDataTransport)])(SettingsOrderInternationalForm);
