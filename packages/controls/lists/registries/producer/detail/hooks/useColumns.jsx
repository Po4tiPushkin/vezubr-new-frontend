    ...
    () => [
      {
        ...
        render: (id, record, index) => (
          <LinkWithBack id={`registry-number-${id}`} to={{ pathname: `/orders/${record.orderId}/documents` }}>
            {id}
          </LinkWithBack>
        ),
      },
...

      {
        ...
        render: (id, record) => (
          <LinkWithBack id={`registry-number-${id}`} to={{ pathname: `/orders/${record.orderId}/documents-producer` }}>
            {id}
          </LinkWithBack>
        ),
      },
      ...
      },
      {
        ...
        dataIndex: 'toStartAt',
        key: 'toStartAt',
        render: (toStartDate, record) => (
          <VzTable.Cell.Content>
            {(toStartDate && moment(toStartDate).tz(record.timeZone).format('DD.MM.YYYY HH:mm')) || ''}
          </VzTable.Cell.Content>
        ),
      },
      {
